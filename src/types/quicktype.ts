...
const typeMap: any = {
	...
	PaidPromotion: o([{ json: "@id", js: "@id", typ: "" }], false),
	Price: o(
		[
	...
	Descriptions: o(
		[
			...
			{ json: "vertical", js: "vertical", typ: "" },
			{
				json: "canonical_search_params",
				js: "canonical_search_params",
				typ: "",
			},
		],
		false,
	...
	Vertical: o([{ json: "name", js: "name", typ: "" }], false),
	Paging: o(
		[
			{ json: "param", js: "param", typ: "" },
	...
	Filters: o([{ json: "query", js: "query", typ: "" }], false),
	SelectionFilter: o(
		[
			{ json: "name", js: "name", typ: r("Name") },
			{ json: "value", js: "value", typ: "" },
	...
	Flag: ["private", "retailer", "shipping_exists"],
	ID: ["fiks_ferdig", "fus", "private", "retailer"],
	Text: ["Betalt plassering", "Fiks ferdig", "Forhandler", "Privat"],
	LabelType: ["PRIMARY", "SECONDARY"],
	MainSearchKey: ["SEARCH_ID_BAP_ALL"],
	CurrencyCode: ["NOK"],
	Unit: ["kr"],
	TradeType: ["Til salgs"],
	FinnAdType: ["bap"],
